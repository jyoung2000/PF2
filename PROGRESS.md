...
- [ ] E4 Editor frontend core: `/film/editor` layout, multi-track timeline (tracks/clips/playhead/ruler/markers, drag/move/resize-trim/split/ripple delete+insert/marquee+multi-select/magnetic snapping+toggle/zoom/frame step/track mute-solo-lock), useHistory undo/redo, keyboard shortcuts with tooltips, autosave. ✓ when: vitest component+hook tests, build clean.

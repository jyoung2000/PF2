...
- [ ] E6 Review queue + generation integration: take review states + queue UI (approve/reject/regenerate/compare), timeline-aware generation, batch generation with cost preview, chaining visible in editor. ✓ when: backend+frontend tests.

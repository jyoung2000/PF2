...
const SCREENS = [
  ...
  { name: 'inspiration-research', route: '/inspiration/research', group: 'Inspiration', label: 'Research',
    note: 'Ask a question; PromptForge routes it to the sources that can answer it.' },
  { name: 'inspiration-discover', route: '/inspiration/discover', group: 'Inspiration', label: 'Discover',
    note: 'Ranked shelves — every result carries the reasons it is there.' },
...
const ROUTE_MAP = [
  ...
  ['/inspiration/research', 'inspiration-research.html'], ['/inspiration/discover', 'inspiration-discover.html'],
